...
func TestPrint(t *testing.T) {
	...
	fmt.Printf("branch: %v commit: %v, upstream: %v, ahead: %v, behind: %v\n",
		pi.branch, pi.commit, pi.upstream, pi.ahead, pi.behind,
	)
	for _, en := range pi.Entries {
		fmt.Printf("%+v\n", en)
	}
}
...
var expectedPorcInfo = PorcInfo{
	...
	Entries: []*Entry{
		&Entry{
			...
			ModeIndex:    "100644",
			ModeWorkTree: "100644",
			HashHead:     "3e2ceb914cf9be46bf235432781840f4145363fd",
			HashIndex:    "3e2ceb914cf9be46bf235432781840f4145363fd",
			Path:         "Gopkg.lock",
		},
		// 1 .M N... 100644 100644 100644 cecb683e6e626bcba909ddd36d3357d49f0cfd09 cecb683e6e626bcba909ddd36d3357d49f0cfd09 Gopkg.toml
		// 1 .M N... 100644 100644 100644 aea984b7df090ce3a5826a854f3e5364cd8f2ccd aea984b7df090ce3a5826a854f3e5364cd8f2ccd porcelain.go
